...
### 1.1.3 转换理论
1. 短语范畴的转换
    1. 主题化规则：移动任意的短语 $\text{XP}$, 并将其置于语句成分的最左端
    2. $\text{wh}-$移动：移动任意 $\text{wh}-$短语到补语化成分的节点之下
        1. $[+\text{Q}]-\text{Comp}$ 条件：只有当 $\text{Comp}$ 具有范畴特征 $[+\text{Q}]$ 时, $\text{wh}-\text{XP}$ 才能移动到该补语化成分节点 $\text{Comp}$ 之下
        2. $\text{wh}-$隔离条件：作 $\text{wh}-\text{XP}$ 移动的内含子句所属的补语化节点 $\text{Comp}$ 受主句动词的支配，从而能支配该 $\text{wh}-$短语
    ...
    4. 附加成分转换：移动任意短语 $\text{XP}$，并将其置于动词短语 $\text{VP}$ 的最右端
    5. 笨重名词短语的转移：移动一个「笨重」的名词短语 $\text{NP}$，并将其置于动词短语 $\text{VP}$ 成分的最右端
2. 终端范畴的转换
    1. 主要动词的词缀跳跃：词范畴节点 $\text{Aux}$ 移动时态\范畴 $\text{Tense}$ 到动词范畴节点 $\mathrm{V}$ 之下，如果
        1. $\text{Aux}$ 不支配一个情态动词或否定词范畴
        2. $\text{V}$ 具有特征属性 $[-\mathrm{AUX}]$
        3. $\text{VP}$ 不支配具有特征属性 $[+\mathrm{AUX}]$ 的动词范畴 $\mathrm{V}$
        4. $\text{Aux}$ 邻近支配目标动词 $\text{V}$ 的动词短语 $\text{VP}$
    2. 助动词的 $\text{V}-$提升：提升动词范畴 $\text{V}$ 到助动词范畴节点 $\text{Aux}$ 之下，如果
        1. $\mathrm{V}$ 具有特征属性 $[+\mathrm{AUX}]$
    ...
    4. $\text{yes}-\text{no}$ 问句中的主语—助动词倒置：移动助动词范畴 $\text{Aux}$ 到引导词范畴 $\text{Comp}$ 之下，如果
        1. $\text{Comp}$ 具有特征属性 $[+\mathrm{Q}]$
        2. $\operatorname{Comp}$ 位于一个要子句中
