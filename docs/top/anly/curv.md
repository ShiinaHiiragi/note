...
2. 椭圆的性质：设 $E: \dfrac{x^2}{a^2} + \dfrac{y^2}{b^2} = 1 \ (a > b > 0)$ 为一个椭圆
    ...
    3. 离心率：设半焦距 $c = \sqrt{a^2 - b^2}$，定义椭圆 $E$ 的离心率 $e = \dfrac ca \in (0, 1)$，$e$ 也是椭圆上的点到焦点的距离与到准线的距离之比．取 $e = 0$，则椭圆退化为圆
3. 圆：到顶点距离为定长的点集
...
2. 双曲线的性质：设 $H: \dfrac{x^2}{a^2} - \dfrac{y^2}{b^2} = 1 \ (a, b > 0)$ 为一个双曲线
    ...
    4. 离心率：设半焦距 $c = \sqrt{a^2 + b^2}$，定义椭圆 $E$ 的离心率 $e = \dfrac ca \in (1, +\infty)$，$e$ 也是双曲线上的点到焦点的距离与到准线的距离之比
...
2. 抛物线的性质：设 $P_1: y^2 = 2px, P_2: x^2 = 2py \ (p > 0)$ 为两个抛物线
    ...
    3. 离心率：抛物线上的点到焦点的距离与到准线的距离之比 $e = 1$
