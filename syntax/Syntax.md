...
1. IA-32（x86）：由英特尔公司于 1985 年推出的指令集架构，**复杂指令集**。它是 8086 架构的延伸版本，**可支持 32 位运算**，首次应用在 Intel 80386 芯片中

    > IA-64：是显式并行指令运算的 64 位架构。EPIC 是基于超长指令字 VLIW 的设计，此架构**与 x86 及 x86-64 并不相容**，操作系统与软件需使用 IA-64 专用版本。2017 年，Intel 停止了 Itanium 处理器的开发
